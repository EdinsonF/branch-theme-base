 ...
 * @param {boolean} isOpenCart - open cart or no (if true opening cart
 * went add product )
 */
 const addProducts = async (itemId, isOpenCart) => {
  ...
  if (isOpenCart) {
    dataToggle($Q("#shopify-section-side-cart"), isOpenCart);
  }
